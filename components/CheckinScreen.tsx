      ...
      <div className="fixed inset-0 bg-white flex flex-col font-sans z-50">
        <div className="flex items-center justify-between gap-3 px-4 py-3 border-b border-slate-100 shrink-0">
          <div className="min-w-0">
            <h1 className="text-sm font-black text-slate-900 uppercase tracking-tight truncate">Assine Aqui</h1>
            <p className="text-slate-400 text-xs truncate">{selectedVoter.name} • Matrícula {selectedVoter.matricula}</p>
          </div>
          <div className="flex items-center gap-2 shrink-0">
            <button
              onClick={clearSignature}
              className="flex items-center gap-1.5 px-3 py-2 bg-slate-100 text-slate-600 rounded-lg text-xs font-bold uppercase hover:bg-slate-200 transition-colors"
            >
            ...
            <button
              ...
              className="px-4 py-2 bg-indigo-600 text-white rounded-lg text-xs font-bold uppercase hover:bg-indigo-700 transition-colors disabled:opacity-50"
            >
        ...
        {submitError && (
          <p className="text-red-600 text-xs font-bold text-center flex items-center justify-center gap-1 py-1.5 shrink-0 bg-red-50">
